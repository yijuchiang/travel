    ...
    <div className='my-container'>
      ...
      <section className="ticket">
        ...
        <div className="final_check">
          <h3 className="option">請選擇日期、數量</h3>
          <div className='final_detail'>
            ...
            <div className="w-[360px] relative mb-1">
              <div className="absolute right-0 bottom-0 p-4">
                <p className=' mb-2'>請選擇人數：</p>
                <div>
                  <p className='mb-2'>NT${ticket.price}/每人</p>
                  <div className='flex gap-2'>
                    <button className='bg-[#26bec9] text-white rounded-full w-6 h-6 inline-flex items-center justify-center' onClick={() => setAmount(prev => Math.max(prev - 1, 1))}><i className="fa-solid fa-minus "></i></button>
                    {amount}
                    <button className='bg-[#26bec9] text-white rounded-full w-6 h-6 inline-flex items-center justify-center' onClick={() => setAmount(prev => prev + 1)}><i className="fa-solid fa-plus "></i></button>
                  </div>
                </div>
              </div>
            </div>
